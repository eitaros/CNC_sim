...
void ActionInitialization::SetProperties(int l, char* dettype)
{
  return;
  /* RunAction* runAction = new RunAction;
  runAction->SetFilename(l,dettype); */
} 
...
{
  RunAction* runAction = new RunAction(fDetConstruction);
...
void ActionInitialization::Build() const
{
  ...
  RunAction* runAction = new RunAction(fDetConstruction);
  SetUserAction(runAction);
  //runAction->SetFilename(lg_length, dettype);
  ...
  //DetectorConstruction* detCon = fDetConstruction;
  SetUserAction(new SteppingAction(eventAction, detCon));
